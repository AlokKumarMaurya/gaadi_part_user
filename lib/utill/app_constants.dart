...
class AppConstants {
  static const String APP_NAME = 'Gaadi Part';
  static const String APP_VERSION = '11.0';
  // static const String BASE_URL = 'https://6valley.6amtech.com';
  // static const String BASE_URL = 'https://pearltheluxurylounge.com';
  static const String BASE_URL = 'https://softfix.in/demo/gaadipart';
  static const String USER_INFO=BASE_URL+"/api/v2/user/info/";
  static const String USER_INFO_UPDATE=BASE_URL+"/api/v2/user/info/update";
  static const String TERMS_AND_CONDITIONS=BASE_URL+"/api/v1/policies/term";
  static const String RETURN_POLICY=BASE_URL+"/api/v1/policies/return";
  static const String SUPPORT_API=BASE_URL+"/api/v1/policies/support";
  static const String GET_PRIVACY_POLICY=BASE_URL+"/api/v1/policies/support";
  static const String USER_ID = 'userId';
  static const String NAME = 'name';
  // static const String CATEGORIES_URI = '/api/v1/categories';
  static const String BREAK_AND_SUSPENSION = "${BASE_URL}/api/v2/brands/top";
  static const String ADD_SHIPPING_ADDRES=BASE_URL+"/api/v2/user/shipping/create";
  static const String GET_ALL_ADDRESS=BASE_URL+"/api/v2/user/shipping/address/";
  static const String CATEGORIES_URI = '${BASE_URL}/api/v2/categories';
  static const String BRANDS_URI = '${BASE_URL}/api/v2/brands';
  ...
  static const String CATEGORY_PRODUCT_URI = '${BASE_URL}/api/v1/products/category/';
  static const String REGISTRATION_URI = '${BASE_URL}/api/v1/auth/register';
  static const String LOGIN_URI = '${BASE_URL}/api/v2/auth/login';
  ...
  static const String BEST_SELLING_PRODUCTS_URI = '${BASE_URL}/api/v2/products/best-seller';
  static const String DISCOUNTED_PRODUCTS_URI = '/api/v1/products/discounted-product?limit=10&&offset=';
  static const String FEATURED_PRODUCTS_URI = '${BASE_URL}/api/v2/products/featured';
  ...
  static const String SEARCH_URI = '${BASE_URL}/api/v2/products/search?';
  ...
  // static const String ADDRESS_LIST_URI = '/api/v2/customers/show';
  ...
  static const String MAIN_BANNER_URI = '${BASE_URL}/api/v2/banners';
  ...
  static const String ORDER_PLACE_URI = '$BASE_URL/api/v2/order-placed';
  static const String ORDER_CONFIRMED_URI = '$BASE_URL/api/v2/order-confirmed/';
  static const String ORDER_LIST_URI = '$BASE_URL/api/v2/get_order_list';
  ...
  static const String FLASH_DEAL_URI = '/api/v1/products/flash-deal';
  ...
  static const String ADD_TO_CART_URI = '${BASE_URL}/api/v2/carts/addtocart';
  static const String UPDATE_CART_QUANTITY_URI = '${BASE_URL}/api/v1/carts/change-quantity';
  // static const String REMOVE_FROM_CART_URI = '/api/v1/cart/remove';
  static const String REMOVE_FROM_CART_URI = '${BASE_URL}/api/v2/carts/';
  ...
  static const String DEAL_OF_THE_DAY_URI = '${BASE_URL}/api/v1/products/todays-deal';
  ...
  static const String GET_ORDER_LIST=BASE_URL+"/api/v2/order/list";
  //address
