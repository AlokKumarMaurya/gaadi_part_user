...
class _MapWidgetState extends State<MapWidget> {
  ...
  void initState() {
    ...
    _latLng = LatLng(double.parse("26.8520124"), double.parse("81.022678"));
    _setMarker();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: [
        ...
        CustomAppBar(title: 'delivery_address'),
        Positioned(
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text("widget.address.addressType", style: robotoRegular.copyWith(
                        fontSize: Dimensions.FONT_SIZE_SMALL, color: Color(0xFFF1F1F1),
                      )),
