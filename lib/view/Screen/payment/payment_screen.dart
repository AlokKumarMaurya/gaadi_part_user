      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            CustomAppBar(title: 'PAYMENT', onBackPressed: () => _exitApp(context)),
                      ...
                      if(url.contains(AppConstants.BASE_URL)) {
                        ...
                        if (_isSuccess) {
                          ...
                          showAnimatedDialog(context, MyDialog(
                            icon: Icons.done,
                            title: 'payment_done',
                            description: 'your_payment_successfully_done',
                          ...
                          showAnimatedDialog(context, MyDialog(
                            ...
                            description: 'your_payment_failed',
                            isFailed: true,
                          ), dismissible: false, isFlip: true);
                          ...
                          showAnimatedDialog(context, MyDialog(
                            ...
                            description: 'your_payment_cancelled',
                            isFailed: true,
                          ), dismissible: false, isFlip: true);
                        }
                      }
