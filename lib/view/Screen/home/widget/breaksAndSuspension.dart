...
// import '../../dashboardDetailsPage/widget/customViewAllButton.dart';

class BreakAndSuspension extends StatefulWidget {
  final bool isHomePage;

  BreakAndSuspension({@required this.isHomePage});

  @override
  State<BreakAndSuspension> createState() => _BreakAndSuspensionState();
}

class _BreakAndSuspensionState extends State<BreakAndSuspension> {
